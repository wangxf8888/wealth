...
# -*- coding: utf-8 -*-
"""
解析 V5 引擎产物 -> Dashboard data.json + data.js
================================================
输入:
  /home/AIWealth/scripts/priority_v5_trades.log    (管道分隔交易明细)
  /home/AIWealth/scripts/priority_v5_equity.csv    (日权益曲线)
...
TRADES_LOG = os.path.join(ROOT, "scripts", "priority_v5_trades.log")
EQUITY_CSV = os.path.join(ROOT, "scripts", "priority_v5_equity.csv")
...
# ---------------------------------------------------------------- main
def main():
    print(f"[V5 PARSER] trades  : {TRADES_LOG}")
    print(f"[V5 PARSER] equity  : {EQUITY_CSV}")
